...
with tab2:
    ...
    # Línea vertical "Hoy" separando histórico de forecast
    # (usamos add_shape en lugar de add_vline porque este último falla con Timestamps)
    frontera = hist_dates[-1]
    fig_hist.add_shape(
        type="line",
        x0=frontera, x1=frontera,
        y0=0, y1=1,
        yref="paper",
